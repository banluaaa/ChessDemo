...
public abstract class ChessComponent extends JComponent {
    ...
    private static final Color[] BACKGROUND_COLORS = {new Color(247,232,170,255), new Color(136,115,34,255)};
    ...
    public char getSuoXie(){return name;}
    /**
     * @param
     *                <br>
    ...
    protected void paintComponent(Graphics g) {
        ...
        if(isEntered()){
            Color color = new Color(122,115,116,255);
            g.setColor(color);
        }else if(isCanGoTo()){
            Color color = new Color(207,204,201,255);
            g.setColor(color);
        }
